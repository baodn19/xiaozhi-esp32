...
-   **`WakeWord`**: Detects keywords (e.g., "Hello, Xiaozhi", "Hi, ESP") from the audio stream. It runs independently from the main audio processor until a wake word is detected.
