...
private:
    ...
    static void touchpad_timer_callback(void* arg) {
        ...
        const int64_t TOUCH_THRESHOLD_MS = 500;  // Touch duration threshold; >500ms treated as long press
    ...
    void Initializest77916Display() {
        ...
        st77916_vendor_config_t vendor_config = {
            .init_cmds = lcd_init_cmds, // Uncomment these lines to use custom init commands
