...
#define MON_BTLINK_PIN          GPIO_NUM_4      // BT link status detect
#define BOOT_4G5V_PIN           GPIO_NUM_5      // 4G module power
#define BOOT_4GEN_PIN           GPIO_NUM_6      // 4G module enable
#define MON_BATT_PIN            GPIO_NUM_43    	// PMU battery indicator detect
#define MON_BATT_CNT            70    	        // PMU battery detect interval (seconds)
#define MON_USB_PIN				GPIO_NUM_47    	// USB insert detect
