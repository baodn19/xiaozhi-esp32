...
#define Power_Dec GPIO_NUM_47                   // Power button detect pin
#define POWER_CBS_ADC_UNIT ADC_UNIT_1           // Shared ADC unit for power monitoring
#define POWER_USBIN_ADC_CHANNEL ADC_CHANNEL_0   // USB insert detect on GPIO1
#define POWER_BATTERY_ADC_CHANNEL ADC_CHANNEL_6 // Battery level ADC on GPIO7
