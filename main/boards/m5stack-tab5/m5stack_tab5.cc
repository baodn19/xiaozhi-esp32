...
public:
    Pi4ioe1(i2c_master_bus_handle_t i2c_bus, uint8_t addr) : I2cDevice(i2c_bus, addr) {
        ...
        WriteReg(PI4IO_REG_OUT_SET, 0b01110110);     // Output Port Register: P1(SPK_EN), P2(EXT5V_EN), P4(LCD_RST), P5(TP_RST), P6(CAM_RST) driven high
    }
...
public:
    Pi4ioe2(i2c_master_bus_handle_t i2c_bus, uint8_t addr) : I2cDevice(i2c_bus, addr) {
        ...
        WriteReg(PI4IO_REG_OUT_SET, 0b10001001);     // Output Port Register P0(WLAN_PWR_EN), P3(USB5V_EN), P7(CHG_EN) driven high
    }
...
private:
    ...
    void InitializeSt7123Display() {
        ...
        // Use actual ST7123 driver functions
    ...
    void InitializeDisplay() {
        ...
        // Detect ST7123 touch panel (I2C address 0x55)
