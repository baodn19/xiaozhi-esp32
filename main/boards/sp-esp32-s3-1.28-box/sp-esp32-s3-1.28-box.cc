...
public:
    ...
    virtual void SetupUI() override {
        ...
        // Round screen requires extra horizontal padding on the status bar
...
private:
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnShutdownRequest([this]() {
            ...
            // Enable hold so levels stay stable during sleep
    ...
    static void touchpad_timer_callback(void* arg) {
        ...
        const int64_t TOUCH_THRESHOLD_MS = 500;  // Touch duration threshold; >500ms counts as long press
    ...
    void InitializeCst816DTouchPad() {
        ...
        if (!touch_available) {
            ...
            // Release touch I2C to avoid repeated errors when no device
...
public:
    Spotpear_ESP32_S3_1_28_BOX() : boot_button_(BOOT_BUTTON_GPIO) {
        // Initialize touch I2C first and probe/init touch (skip if no touch chip)
        InitializeCodecI2c_Touch();
        InitializeCst816DTouchPad();

        // Initialize audio I2C
        InitializeCodecI2c();

        // Bring up display first
        InitializeSpi();
        ...
        // Initialize power-saving logic after display and backlight are ready to avoid null pointers
