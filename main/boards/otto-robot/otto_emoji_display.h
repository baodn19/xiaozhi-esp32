...
/**
 * @brief Otto robot GIF emoji display class
 * Extends SpiLcdDisplay and adds GIF emoji support via EmojiCollection
 */
class OttoEmojiDisplay : public SpiLcdDisplay {
   public:
    /**
     * @brief Constructor; parameters are the same as SpiLcdDisplay
     */
